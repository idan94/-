...
struct task_struct { 
	//TODO: add restrictionsV, log table, log size, sysTable and iterator
	/*
...
/* Hw1: restrictions addings by Idan */
	int restriction_level;  //[0,2]
/* Hw1: restrictions list by Idan */
	scr *restrictions_list;
/* Hw1: size of restrictions list by Idan */
	int restrictions_list_size;  //[0,numOfSysCalls- 245 for now]
/* Hw1: ​forbidden activity info by Idan */
	fai log_records[100];
/* Hw1: number of logs by Idan */
	int log_records_index; //[0,100]
	/*the ammount of members in the log array*/
	int log_size;
};
...
/*log_array dosent need any initialization*/
